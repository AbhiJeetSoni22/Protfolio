...
const Skills = () => {
  ...
  const getIcon = (category: string) => {
    switch(category) {
      ...
      case "Backend": return <FiCpu className="w-6 h-6" />;
      case "Database": return <FiDatabase className="w-6 h-6" />;
      default: return <FiLayers className="w-6 h-6" />;
    }
  };
  ...
  return (
    <section className="py-20 bg-gray-50 dark:bg-gray-900/50">
      <div className="container max-w-7xl mx-auto px-4">
        ...
        >
          My <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-cyan-500">Skills</span>
        </motion.h2>
